...
<!--       <button class="navbar-toggler d-block d-md-none" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <div class="navbar-expand-md" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a role="button" class="btn btn-secondary btn-sm text-white nav-link mx-1 px-2" target="_blank" href="/work/html_builder.php">HTML Builder</a>
          </li>
        </ul>
      </div>
    </div>
